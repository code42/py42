...
departing employee list. Make sure to note its case ID if you want to do anything else right away:
```python
...
departing employee. However, there is a way to use the username to get a departing employee item.
