...
class StorageRestoreClient(BaseStorageClient):
    ...
    def create_web_restore_session(self, device_guid, data_key_token=None, private_password=None, encryption_key=None,
        ...
        return self._session.post(uri, data=json.dumps(data), **kwargs)
    ...
    def cancel_web_restore_job(self, job_id, **kwargs):
        uri = "/api/WebRestoreJob"
        data = {"jobId": job_id}
        return self._session.delete(uri, data=json.dumps(data), **kwargs)
