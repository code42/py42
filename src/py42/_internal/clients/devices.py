...
class DeviceClient(BaseAuthorityClient):
    ...
    def get_devices(self, active=None, blocked=None, org_uid=None, user_uid=None, target_computer_guid=None,
        ...
        uri = u"/api/Computer"
        params = {u"active": active, u"blocked": blocked, u"orgUid": org_uid, u"userUid": user_uid,
                  u"targetComputerGuid": target_computer_guid, u"incBackupUsage": include_backup_usage,
                  u"incCounts": include_counts, u"pgNum": page_num, u"pgSize": page_size, u"q": q}
