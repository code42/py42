...
class Event:
    class Observer(_FileEventFilterStringField, Choices):
        ...
        Example::
            filter = Event.Observer.is_in([EventObserver.ENDPOINT, EventObserver.BOX])
    ...
    class Action(_FileEventFilterStringField, Choices):
