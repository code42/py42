...
class TestUserClient(object):
    ...
    def test_get_users_calls_get_with_uri_and_params(self, session, mock_get_users_response):
    ...
    def test_get_users_calls_get_expected_number_of_times(
        self, session, mock_get_users_response, mock_get_users_empty_response
    ):
