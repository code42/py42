...
class TestAlertRulesClient(object):
    ...
    def test_alert_rules_module_calls_add_user_with_expected_value(
        ...
        alert_rules_module = AlertRulesClient(mock_alerts_service, mock_alert_rules_service)
    ...
    def test_alert_rules_module_calls_get_all_by_name_with_expected_value(
        ...
        mock_alert_rules_service.get_all_rules_by_name.assert_called_once_with(rule_name)
    ...
    def test_alert_rules_module_calls_get_rules_by_observer_id_with_expected_value(
        ...
        mock_alert_rules_service.get_rule_by_observer_id.assert_called_once_with(rule_id)
