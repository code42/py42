...
def test_date_observed_on_or_after_sets_filter_properties_correctly(
...
def test_date_observed_on_or_before_sets_filter_properties_correctly(
...
def test_date_observed_in_range_sets_filter_properties_correctly(in_range_filter_creator):
    ...
    in_range_filter_creator.assert_called_once_with(
        "CreatedAt", formatted_before, formatted_after
    )
