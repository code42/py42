...
from tests._internal.test_file_event_filter import event_filter_group, event_filter_group_list, file_event_filter
...
def test_md5_eq_sets_filter_properties_correctly(mocker):
    ...
    MD5.eq("test_md5")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("md5Checksum", ["test_md5"])
...
def test_md5_not_eq_sets_filter_properties_correctly(mocker):
    ...
    MD5.not_eq("test_md5")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("md5Checksum", ["test_md5"])
...
def test_md5_is_in_sets_filter_properties_correctly(mocker):
    ...
    MD5.is_in(items)
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("md5Checksum", items)
...
def test_md5_not_in_sets_filter_properties_correctly(mocker):
    ...
    items = ["md51", "md52", "md53"]
    MD5.not_in(items)
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("md5Checksum", items)


def test_sha256_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    SHA256.eq("test_sha256")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("sha256Checksum", ["test_sha256"])


def test_sha256_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    SHA256.not_eq("test_sha256")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("sha256Checksum", ["test_sha256"])
...
def test_sha256_is_in_sets_filter_properties_correctly(mocker):
    ...
    SHA256.is_in(items)
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("sha256Checksum", items)
...
def test_sha256_not_in_sets_filter_properties_correctly(mocker):
    ...
    items = ["sha2561", "sha2562", "sha2563"]
    SHA256.not_in(items)
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("sha256Checksum", items)


def test_os_hostname_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    OSHostname.eq("test_osHostName")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("osHostName", ["test_osHostName"])


def test_os_hostname_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    OSHostname.not_eq("test_osHostName")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("osHostName", ["test_osHostName"])
...
def test_os_hostname_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("osHostName", items)
...
def test_os_hostname_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("osHostName", items)


def test_device_username_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    DeviceUsername.eq("test_deviceUserName")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("deviceUserName", ["test_deviceUserName"])


def test_device_username_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    DeviceUsername.not_eq("test_deviceUsername")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("deviceUserName", ["test_deviceUsername"])
...
def test_device_username_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("deviceUserName", items)
...
def test_device_username_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("deviceUserName", items)


def test_file_name_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    FileName.eq("test_fileName")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("fileName", ["test_fileName"])


def test_file_name_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    FileName.not_eq("test_fileName")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("fileName", ["test_fileName"])
...
def test_file_name_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("fileName", items)
...
def test_file_name_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("fileName", items)


def test_file_path_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    FilePath.eq("test_filePath")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("filePath", ["test_filePath"])


def test_file_path_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    FilePath.not_eq("test_filePath")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("filePath", ["test_filePath"])
...
def test_file_path_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("filePath", items)
...
def test_file_path_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("filePath", items)


def test_public_ip_address_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    PublicIPAddress.eq("test_publicIp")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("publicIpAddress", ["test_publicIp"])


def test_public_ip_address_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    PublicIPAddress.not_eq("test_publicIp")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("publicIpAddress", ["test_publicIp"])
...
def test_public_ip_address_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("publicIpAddress", items)
...
def test_public_ip_address_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("publicIpAddress", items)


def test_private_ip_address_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    PrivateIPAddress.eq("test_privateIp")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("privateIpAddresses", ["test_privateIp"])


def test_private_ip_address_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    PrivateIPAddress.not_eq("test_privateIp")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("privateIpAddresses", ["test_privateIp"])
...
def test_private_ip_address_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("privateIpAddresses", items)
...
def test_private_ip_address_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("privateIpAddresses", items)


def test_event_type_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    EventType.eq("test_eventType")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("eventType", ["test_eventType"])


def test_event_type_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    EventType.not_eq("test_eventType")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("eventType", ["test_eventType"])
...
def test_event_type_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("eventType", items)
...
def test_event_type_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("eventType", items)
...
def test_exposure_type_any_sets_filter_properties_correctly(mocker):
    ...
    ExposureType.any()
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("exposure", items)


def test_exposure_type_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_eq_filter_group")
    ExposureType.eq("test_exposure")
    py42._internal.file_event_filter.create_eq_filter_group.assert_called_with("exposure", ["test_exposure"])


def test_exposure_type_not_eq_sets_filter_properties_correctly(mocker):
    mocker.patch("py42._internal.file_event_filter.create_not_eq_filter_group")
    ExposureType.not_eq("test_exposure")
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("exposure", ["test_exposure"])
...
def test_exposure_type_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_eq_filter_group.assert_called_with("exposure", items)
...
def test_event_timestamp_on_or_after_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_on_or_after_filter_group.assert_called_with("eventTimestamp", formatted)
...
def test_event_timestamp_on_or_before_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_on_or_before_filter_group.assert_called_with("eventTimestamp", formatted)
...
def test_event_timestamp_in_range_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_in_range_filter_group.assert_called_with("eventTimestamp",
