...
def test_md5_is_in_sets_filter_properties_correctly(mocker):
    ...
    MD5.is_in(items)
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("md5Checksum", items)
...
def test_md5_not_in_sets_filter_properties_correctly(mocker):
    ...
    items = ["md51", "md52", "md53"]
    MD5.not_in(items)
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("md5Checksum", items)
...
def test_sha256_is_in_sets_filter_properties_correctly(mocker):
    ...
    SHA256.is_in(items)
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("sha256Checksum", items)
...
def test_sha256_not_in_sets_filter_properties_correctly(mocker):
    ...
    items = ["sha2561", "sha2562", "sha2563"]
    SHA256.not_in(items)
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("sha256Checksum", items)
...
def test_os_hostname_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("osHostName", items)
...
def test_os_hostname_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("osHostName", items)
...
def test_device_username_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("deviceUserName", items)
...
def test_file_name_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("fileName", items)
...
def test_file_name_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("fileName", items)
...
def test_file_path_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("filePath", items)
...
def test_file_path_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("filePath", items)
...
def test_public_ip_address_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("publicIpAddress", items)
...
def test_public_ip_address_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("publicIpAddress", items)
...
def test_private_ip_address_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("privateIpAddresses", items)
...
def test_private_ip_address_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("privateIpAddresses", items)
...
def test_event_type_is_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("eventType", items)
...
def test_event_type_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("eventType", items)
...
def test_exposure_type_any_sets_filter_properties_correctly(mocker):
    ...
    ExposureType.any()
    py42._internal.file_event_filter.create_is_in_filter_group.assert_called_with("exposure", items)
...
def test_exposure_type_not_in_sets_filter_properties_correctly(mocker):
    ...
    py42._internal.file_event_filter.create_not_in_filter_group.assert_called_with("exposure", items)
