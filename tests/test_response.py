...
class TestPycpgResponse:
    ...
    def test_getitem_returns_list_items_with_data_node(
        ...
        response = PycpgResponse(mock_response_list_data_node)
    ...
    def test_getitem_returns_dict_keys_with_data_node(
        ...
        response = PycpgResponse(mock_response_dict_data_node)
    ...
    def test_raw_text_no_data_node_returns_raw_json_no_data_node(
        ...
        response = PycpgResponse(mock_response_not_json)
    ...
    def test_setitem_raises_pycpg_error_on_invalid_assignment(
        self, mock_response_not_json
    ):
        response = PycpgResponse(mock_response_not_json)
    ...
    def test_getitem_raises_pycpg_error_on_invalid_subscript(
        self, mock_response_not_json
    ):
        response = PycpgResponse(mock_response_not_json)
        with pytest.raises(PycpgError):
